          ...
          <div className='grid grid-cols-3 gap-4 mt-5'>
              ...
              <table className='table-auto w-full'>
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>Product Name</td>
                    <td><img width={'70px'} height={'70px'} src="https://img.uline.com/is/image/uline/H-4568?$Mobile_Zoom$" alt="" /></td>
                    <td>
                      <div className='flex'>
            ...
            <div className='col-span-1'>
              <div className='border rounded p-5'>
                <h2 className='text-2xl font-bold my-4'>Total Amount: <span className='text-red-600'>$50.4</span></h2>
                <hr />
